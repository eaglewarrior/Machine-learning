...
2) In Hierarchical_Clustering we have used the mall.csv where we cluster people according to their income & spending habits 
Here is an interesting concept of dendogram is introduced which is helpful for knowing how many clusters we need for segmentation.
...
Here we use a dataset describing the customers leaving or retaining in bank and how several factors are affecting the retain and exit of customers .Using ANN in python.
